...
import RightOwnerAddFilmsForm from "./components/forms/rightOwner/RightOwnerAddFilmsForm";
...
function Routes() {
  return (
    <div>
      ...
      <Route
        path="/filmAgent/FilmAgentRegistration"
        exact
        component={FilmAgentRegistration}
      />
      <Route
        path="/cinemaGoer/CinemaGoerRegistration"
        exact
        component={CinemaGoerRegistration}
      />
      <Route
        path="/filmAgent/newAgent/NewFilmAgent"
        exact
        component={NewFilmAgent}
      />
      <Route
        path="/filmAgent/newAgent/NewFilmExhibitor"
        exact
        component={NewFilmExhibitor}
      />
      <Route
        path="/filmAgent/registeredAgent/RegisteredFilmAgent"
        exact
        component={RegisteredFilmAgent}
      />
      <Route
        path="/cinemaGoer/registeredCinemaGoer/RegisteredCinemaGoer"
        exact
        component={RegisteredCinemaGoer}
      />
      <Route
        path="/cinemaGoer/registeredCinemaGoer/CinemaGoer"
        exact
        component={CinemaGoer}
      />
      <Route
        path="/filmAgent/newAgent/NewRightOwner"
        exact
        component={NewRightOwner}
      />
      <Route
        path="/filmAgent/newAgent/NewFilmFestival"
        exact
        component={NewFilmFestival}
      />
      <Route
        path="/filmAgent/newAgent/NewCinemaOrCinemaGroup"
        exact
        component={NewCinemaOrCinemaGroup}
      />
      <Route
        path="/filmAgent/newAgent/NewCinemaGroup"
        exact
        component={NewCinemaGroup}
      />
      <Route path="/filmAgent/newAgent/NewCinema" exact component={NewCinema} />
      <Route
        path="/filmAgent/registeredAgent/filmFestival/FilmFestival"
        exact
        component={FilmFestival}
      />
      <Route
        path="/filmAgent/registeredAgent/filmFestival/FilmFestivalAgents"
        exact
        component={FilmFestivalAgents}
      />
      <Route
        path="/filmAgent/registeredAgent/filmFestival/FilmFestivalEditions"
        exact
        component={FilmFestivalEditions}
      />
      <Route
        path="/filmAgent/registeredAgent/cinemaGroup/CinemaGroup"
        exact
        component={CinemaGroup}
      />
      <Route
        path="/filmAgent/registeredAgent/cinemaGroup/CinemaGroupAgents"
        exact
        component={CinemaGroupAgents}
      />
      <Route
        path="/filmAgent/registeredAgent/cinemaGroup/CinemaGroupCinemas"
        exact
        component={CinemaGroupCinemas}
      />
      <Route
        path="/filmAgent/registeredAgent/cinema/Cinema"
        exact
        component={Cinema}
      />
      <Route
        path="/filmAgent/registeredAgent/cinema/CinemaAgents"
        exact
        component={CinemaAgents}
      />
      <Route
        path="/filmAgent/registeredAgent/cinema/CinemaProgram"
        exact
        component={CinemaProgram}
      />
      <Route
        path="/filmAgent/registeredAgent/rightOwner/RightOwner"
        exact
        component={RightOwner}
      />
      <Route
        path="/filmAgent/registeredAgent/rightOwner/RightOwnerAgents"
        exact
        component={RightOwnerAgents}
      />
      <Route
        path="/filmAgent/registeredAgent/rightOwner/RightOwnerFilms"
        exact
        component={RightOwnerFilms}
      />
      <Route
        path="/filmAgent/registeredAgent/rightOwner/RightOwnerDetails"
        exact
        component={RightOwnerDetails}
      />
      <Route
        path="/filmAgent/registeredAgent/filmFestival/FilmFestivalDetails"
        exact
        component={FilmFestivalDetails}
      />
      <Route
        path="/filmAgent/registeredAgent/cinemaGroup/CinemaGroupDetails"
        exact
        component={CinemaGroupDetails}
      />
      <Route
        path="/filmAgent/registeredAgent/cinema/CinemaDetails"
        exact
        component={CinemaDetails}
      />
      <Route
        path="/filmAgent/registeredAgent/cinema/CinemaHalls"
        exact
        component={CinemaHalls}
      />
      <Route
        path="/filmAgent/registeredAgent/cinema/CinemaTicketTypes"
        exact
        component={CinemaTicketTypes}
      />
      <Route
        path="/cinemaGoer/registeredCinemaGoer/filmScreenings/Screenings"
        exact
        component={Screenings}
      />
      <Route
        path="/filmAgent/registeredAgent/filmFestival/FilmFestivalScreenings"
        exact
        component={FilmFestivalScreenings}
      />
      <Route
        path="/cinemaGoer/newCinemaGoer/NewCinemaGoer"
        exact
        component={NewCinemaGoer}
      />
      <Route
        path="/cinemaGoer/registeredCinemaGoer/filmScreenings/Tickets"
        exact
        component={Tickets}
      />
      <Route
        path="/cinemaGoer/registeredCinemaGoer/films/ScreeningsOfSelectedFilm"
        exact
        component={ScreeningsOfSelectedFilm}
      />
      <Route
        path="/cinemaGoer/registeredCinemaGoer/films/Films"
        exact
        component={Films}
      />
      <Route
        path="/filmAgent/AccessControlContainer"
        exact
