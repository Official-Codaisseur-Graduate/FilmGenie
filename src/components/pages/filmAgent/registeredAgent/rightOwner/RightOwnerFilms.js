...
export default class RightOwnerFilms extends React.Component {
  state = {
    films: [{ title: null, imdbNumber: null, territory: null, startDate: null, endDate: null }]
  }
  ...
  addFilm = () => {
    this.setState({
      films: [...this.state.films, { title: null, imdbNumber: null, Territory: null, startDate: null, endDate: null }]
    })
  }
